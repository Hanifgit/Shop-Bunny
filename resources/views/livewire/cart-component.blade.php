						...
						<ul class="products-cart">
							...
							<li class="pr-cart-item">
								<div class="product-image">
									<figure><img src="{{ asset('storage') }}/{{ $item->model->image }}" alt="{{ $item->model->name }}"></figure>
								</div>
								<div class="product-name">
									<a class="link-to-product" href="{{ URL::to('details/' . $item->model->slug) }}">{{ $item->model->name }}</a>
								</div>
								...
								<div class="quantity">
									<div class="quantity-input">
										...
										<a class="btn btn-increase" href="" wire:click.prevent="increaseQuatity('{{ $item->rowId}}')"></a>
										<a class="btn btn-reduce" href="" wire:click.prevent="decreaseQuatity('{{ $item->rowId}}')"></a>
										{{-- <a class="incbtn" href="{{ route('incQunty',$item->rowId) }}">
											<i class="fa fa-plus" aria-hidden="true"></i>
										</a>
										<a class="incbtn" href="{{ route('redcQunty',$item->rowId) }}">
